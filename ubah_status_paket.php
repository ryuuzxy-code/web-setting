...
echo "<script>alert('Sukses mengupdate status Paket');location.href='histori.php';</script>";
} else {
    echo "<script>alert('Gagal mengupdate status Paket');location.herf='histori.php';</script>";
}
